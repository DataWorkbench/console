...
import {
  ...
  PbrequestListApiServices,
  PbrequestListApiVersions,
  PbrequestListAuthKeys,
  PbrequestListDataServiceClusters,
  PbrequestListNotifications,
  PbrequestListRoutes,
...
export type ListNotificationsRequestType = {
  ...
  data?: PbrequestListNotifications
}
...
export type ListDataServiceApiVersionsRequestType = {
  ...
  data?: PbrequestListApiVersions
}
export type ListDataServiceApisRequestType = {
  uri: {
    space_id: string
    group_id: string
  }
...
export type ListApiServicesRequestType = {
  ...
  data?: PbrequestListApiServices
}
export type ListRoutesRequestType = {
  uri: {
    space_id: string
  }
  data?: PbrequestListRoutes
}
