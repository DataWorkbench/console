...
const JobModeIconWrapper = styled('div')(
  ({ selected }: { selected?: boolean }) => [
    tw`w-[120px] h-[120px] rounded-[25px] flex items-center justify-center rounded-tr-none`,
    {
      background: selected
        ? 'linear-gradient(68.86deg, rgba(21, 166, 117, 0.8) 5.04%, rgba(76, 94, 112, 0) 122.58%)'
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div tw="h-10 mt-2 text-xs font-medium text-neut-8 space-x-2">
          {desc}
        </div>
        {items?.length > 0 && (
          <Select
