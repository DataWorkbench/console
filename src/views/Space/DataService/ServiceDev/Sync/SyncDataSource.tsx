import { useRef, useState, useImperativeHandle, useMemo, useEffect } from 'react'
import { observer } from 'mobx-react-lite'
import tw, { css, styled } from 'twin.macro'
import { useImmer } from 'use-immer'
import { findKey, get, pick, isEmpty, isEqual, trim, camelCase, keys } from 'lodash-es'
...
import { useStore, useQuerySourceTables, useQuerySourceTableSchema } from 'hooks'
...
interface SyncDataSourceProps {
  ...
  onSelectTable?: (tp: OpType, tableName: string, data: Record<string, any>[]) => void
  conf?: {
    source_id?: string
    target_id?: string
