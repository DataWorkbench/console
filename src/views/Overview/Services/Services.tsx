...
const Content = tw(
  CardContent
)`py-2.5 flex font-medium text-sm text-neut-15 h-80 space-x-4`
const Main = tw.div`border border-green-4 border-dashed rounded-sm bg-green-0 px-12 2xl:px-[68px] flex items-center flex-1`
