...
module.exports = {
  // 中性色
  font: {
    h1: 'var(--dw-color-text-h1)',
    h2: 'var(--dw-color-text-h2)',
    h3: 'var(--dw-color-text-h3)',
    secondary: 'var(--dw-color-text-secondary)',
  ...
  // 功能色
  info: {
    DEFAULT: 'var(--dw-color-function-info-default)',
    hover: 'var(--dw-color-function-info-hover)',
  ...
  // 成功色
  success: {
    DEFAULT: 'var(--dw-color-function-success-default)',
  ...
  // 警示色
  error: {
    DEFAULT: 'var(--dw-color-function-error-default)',
  ...
  // 提醒色
  warning: {
    DEFAULT: 'var(--dw-color-function-warning-default)',
  ...
  icon: {
    single: {
      dark: 'var(--dw-color-icon-single-dark)',
      darkgray: 'var(--dw-color-icon-single-darkgray)',
      gray: 'var(--dw-color-icon-single-gray)',
    ...
    double: {
      ...
      lightgray: 'var(--dw-color-icon-double-light-gray)',
